      ...
      <div className="space-y-5 relative z-10">
        ...
        <button
          ...
          className={`w-full py-4 rounded-xl text-sm font-black tracking-widest uppercase transition-all shadow-lg transform active:scale-[0.98] ${
            txStatus === 'pending'
              ? 'bg-emerald-500/30 cursor-wait text-white/70 border border-emerald-500/30'
              : !isConnected || !distributeAmount || Number(distributeAmount) <= 0
                ...
                : 'bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 text-white shadow-emerald-500/30 hover:shadow-emerald-500/50 hover:scale-[1.01]'
          }`}
        >
          {txStatus === 'pending' ? (
            ...
            isConnected ? 'Send to Multiple Wallets' : 'Connect Wallet to Continue'
          )}
        </button>
