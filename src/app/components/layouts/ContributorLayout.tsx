...
export const ContributorLayout: React.FC<ContributorLayoutProps> = ({ children }) => {
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <aside className="col-span-12 lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 space-y-2">
              ...
              <NavItem href="/contributor/dashboard" label="Dashboard" icon="📊" />
              <NavItem href="/contributor/projects" label="My Projects" icon="🎬" />
              <NavItem href="/contributor/revenue" label="My Revenue" icon="💰" />
              <NavItem href="/contributor/payouts" label="Payouts" icon="💸" />
              <NavItem href="/contributor/settings" label="Settings" icon="⚙️" />
            </div>
          </aside>
